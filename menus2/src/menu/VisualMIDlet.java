...
if (command == backCommand) {//GEN-END:|7-commandAction|1|35-preAction
 // write pre-action user code here
//GEN-LINE:|7-commandAction|2|35-postAction
 // write post-action user code here
} else if (command == okCommand) {//GEN-LINE:|7-commandAction|3|33-preAction
 // write pre-action user code here
//GEN-LINE:|7-commandAction|4|33-postAction
 // write post-action user code here
    int n, n2, suma;
     n = Integer.parseInt(num1.getString());
...
if (form == null) {//GEN-END:|26-getter|0|26-preInit
 // write pre-init user code here
form = new Form ("form", new Item[] { getNum1 (), getNum2 (), getRes () });//GEN-BEGIN:|26-getter|1|26-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: num1 ">//GEN-BEGIN:|29-getter|0|29-preInit
/**
 * Returns an initiliazed instance of num1 component.
 * @return the initialized component instance
 */
public TextField getNum1 () {
if (num1 == null) {//GEN-END:|29-getter|0|29-preInit
 // write pre-init user code here
num1 = new TextField ("Introduce el N\u00B0", null, 32, TextField.ANY);//GEN-LINE:|29-getter|1|29-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: num2 ">//GEN-BEGIN:|30-getter|0|30-preInit
/**
 * Returns an initiliazed instance of num2 component.
 * @return the initialized component instance
 */
public TextField getNum2 () {
if (num2 == null) {//GEN-END:|30-getter|0|30-preInit
 // write pre-init user code here
num2 = new TextField ("Introduce Otro:", null, 32, TextField.ANY);//GEN-LINE:|30-getter|1|30-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: res ">//GEN-BEGIN:|31-getter|0|31-preInit
/**
 * Returns an initiliazed instance of res component.
 * @return the initialized component instance
 */
public TextField getRes () {
if (res == null) {//GEN-END:|31-getter|0|31-preInit
 // write pre-init user code here
res = new TextField ("Resultado", null, 32, TextField.ANY);//GEN-LINE:|31-getter|1|31-postInit
 // write post-init user code here
