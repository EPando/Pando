...
% Last Modified by GUIDE v2.5 02-Aug-2013 12:09:07
...
am=str2double(get(handles.Amp,'String'));
ent=str2double(get(handles.Signal,'String'));
x=-pi:0.01:pi;
y=am*sin(x*ent);
